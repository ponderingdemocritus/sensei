...
export const haiku =
  "create me a japanese haiku about sensei, learning and wisdom or any topic you decide. Only return the poem.";

export const nyc =
  "create me a image prompt to pass into dalle - make a random image of the New York City skyline which includes the words OHAYO, you can choose any theme that you want, use a mix of realism and or anime. Only return the prompt.";
